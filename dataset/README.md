...
A Região Integrada de Segurança Pública – RISP é uma das divisões territoriais administrativas existentes no estado de Minas Gerais e é frequentemente utilizada pela SEJUSP em estudos e análises de segurança pública, além da divisão por municípios. Atualmente, Minas Gerais possui 19 RISPs.

Os dados estão disponíveis a partir de 2012, tendo em vista que a implantação do sistema REDS em todo o estado de Minas Gerais ocorreu no final de 2011.
